...
Give 2-4 useful related words, 3-5 close synonyms, and 3-5 real French words sharing a notable spelling pattern. Keep every field concise. Prioritize words, meanings, collocations, register distinctions, and nuances that are useful and realistically expected at CEFR ${targetLevel}; avoid unnecessarily elementary or overly advanced suggestions unless needed to explain the input. Pattern words should share a useful beginning such as frin-/fri- or the same ending; they do not need to be semantically related, so never label them as a word family unless that is true. Label the exact prefix or suffix. Do not claim a shared word family unless it is real. Preserve accents, gender markers, and reflexive pronouns. For adjectives, include feminine form when irregular. Do not include examples or unrelated tables.`, 3000);
