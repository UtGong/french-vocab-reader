...
type Result = { format: "sentence" | "story"; title: string; story: string; translation: string; translationSource?: string; usedWords: Vocabulary[]; newWords: Vocabulary[]; note: string };
